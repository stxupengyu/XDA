...
class T5Stack(T5PreTrainedModel):
    def __init__(self, config, embed_tokens=None, prefix_length=0, prefix_set_number=0, enable_layer_wise_prefix=True):
        ...
        if self.use_input_prefix_embeds and not self.is_decoder:
            # print('prefix_length * config.d_model * config.num_layers', prefix_length * config.d_model * config.num_layers)
            # print('prefix_set_number', prefix_set_number)
    ...
    def forward(
        ...
        if self.use_input_prefix_embeds and not self.is_decoder:
            ...
            if self.enable_layer_wise_prefix:
                # print('task_ids', task_ids)
                # print('self.prefix_embedding(task_ids)', self.prefix_embedding(task_ids))
